package com.cap.springmvc.general.common.api;
...
public interface NlsBundleApplicationRoot extends NlsBundle {
  ...
  /**
   * @see com.cap.springmvc.general.common.api.exception.IllegalEntityStateException
   *
  ...
  /**
   * @see com.cap.springmvc.general.common.api.exception.NoActiveUserException
   *
   * @return the {@link NlsMessage}.
   */
